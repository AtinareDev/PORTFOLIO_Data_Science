...
| [🔗 Pipeline ](https://github.com/AtinareDev/mlops-ci-cd-model-monitoring) | Pipeline MLOps orientado a producción para entrenar, validar y monitorizar modelos de machine learning mediante un flujo CI/CD automatizado. | MLOps, GitHub Actions/Pages, PyTest, ruff,  |
